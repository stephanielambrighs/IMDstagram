<?php
    ...
    foreach($allPosts as $post){
        ...
        $htmlOutput .= '
            <div class="col-9-edit' . $postUniqueName .'">
        ...
        if ($isAdminPage){
            ...
            $htmlOutput .= '
                ...
                <button class="dropdown-item btn-archieve" id="btn-archieve-' . $postUniqueName .'" >Delete</button>
                </div>
            ';
        }
        ...
        $htmlOutput .= '
                ...
                <p id="postDate">' . $post->getUploadedTimeAgo() .'</p>
            </div>
            ...
            <div class="col-3-edit' . $postUniqueName .'">
