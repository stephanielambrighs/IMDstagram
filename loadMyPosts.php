<?php
    ...
    if ($isAdminPage){
        ...
        $allPosts = Db::getAllMyPosts($currentPagePostCount);
    }
    ...
    foreach($allPosts as $post){
        ...
        $htmlOutput .= '
            ...
            <button class="dropdown-item btn-delete" id="btn-delete-' . $postUniqueName .'" >Delete</button>
            </div>
        ';
        ...
        $htmlOutput .= '
                ...
                <p class="time">' . $post->getUploadedTimeAgo() .'</p>
            </div>
